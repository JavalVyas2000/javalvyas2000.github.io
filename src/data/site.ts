...
export type Project = {
  ...
  repo?: string;
  highlights?: string[];
  metrics?: { label: string; value: string }[]; // optional “impact” row
};
...
export const site: SiteData = {
  ...
  avatar: "/profile.jpg", // add this file to /public
  ...
  projects: [
    ...
    },
    {
      ...
      blurb: "End-to-end volatility forecasting: feature engineering → training → artifact outputs built for monitoring.",
