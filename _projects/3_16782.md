...
<div class="button-container">
    <div class="button-group">
        ...
        <button type="button" class="icon-button article-button">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelector('.github-button').addEventListener('click', function() {
        window.location.href = 'https://github.com/FarStryke21/MAPF';
    });

    // Article Button
    document.querySelector('.article-button').addEventListener('click', function() {
        window.location.href = '/files/16745_tyagi_gite_kokil_chulawala.pdf';
    });
});
</script>
---------------------
